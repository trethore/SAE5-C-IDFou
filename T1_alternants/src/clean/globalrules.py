...
RULES_BY_CSV: RulesByCsv = {
    "answers.csv": {
        ...
        "standardisation_rules": {
            ...
            "🌞🎵 À quel moment de la journée écoutez-vous le plus de la musique ? ": ["trimEmoji", "trimSpaces", "convertToQuantitative"],
            ...
            "⏰🎵 Quelle est la durée moyenne des musiques que vous écoutez ?": ["trimEmoji", "trimSpaces", "convertToQuantitative"],
            "🎧🎵 Écoutez-vous plutôt des morceaux ": ["trimEmoji", "trimSpaces", "toString"],
            "🚲🎵 Quel est le tempo des musiques que vous écoutez ?": ["trimEmoji", "trimSpaces", "convertToQuantitative"],
            ...
            "🔊🎵 La qualité de l'audio est importante pour moi": ["trimEmoji", "trimSpaces", "convertToQuantitative"],
            "💪🎵 A quel point êtes vous prêt(e) à découvrir de nouveaux genres ou artistes ?": ["trimEmoji", "trimSpaces", "convertToQuantitative"],
        ...
        "validation_rules": {
            ...
            "🌞🎵 À quel moment de la journée écoutez-vous le plus de la musique ? ": ["notNull", "float", "positiveNumber"],
            ...
            "⏰🎵 Quelle est la durée moyenne des musiques que vous écoutez ?": ["notNull", "float", "positiveNumber"],
            "🎧🎵 Écoutez-vous plutôt des morceaux ": ["notNull", "string"],
            "🚲🎵 Quel est le tempo des musiques que vous écoutez ?": ["notNull", "float", "positiveNumber"],
            ...
            "🔊🎵 La qualité de l'audio est importante pour moi": ["notNull", "float", "positiveNumber"],
            "💪🎵 A quel point êtes vous prêt(e) à découvrir de nouveaux genres ou artistes ?": ["notNull", "float", "positiveNumber"],
