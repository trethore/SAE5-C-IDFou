...
T4_ROOT = Path(__file__).resolve().parents[2]

DEFAULT_DATA_DIR = T4_ROOT / "data" / "raw_data"
DEFAULT_OUTPUT_DIR = T4_ROOT / "data" / "clean"
...
RULES_BY_CSV: RulesByCsv = {
    "tracks.csv": {
        ...
        "standardisation_rules": {
            ...
            "track_file": ["trimSpaces", "toString"],
            "track_url": ["trimSpaces", "toString"],
