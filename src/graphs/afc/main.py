...
def get_nb_factors(contingency_table: pd.DataFrame, X_scaled: pd.DataFrame) -> int:
    ...
    fig, ax = plt.subplots()
    # Création du diagramme en barres pour visualiser les valeurs propres de chaque facteur.
...
def afc(X_scaled: pd.DataFrame, nb_factors: int) -> None:
    ...
    for ax, (method, fa) in zip(axes, methods):
        ...
        # Nuage de points des deux premiers facteurs pour observer la répartition des variables.
